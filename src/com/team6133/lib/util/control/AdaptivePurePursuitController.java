...
public class AdaptivePurePursuitController {
	...
	public static double getLength(RigidTransform2d pose, Translation2d point, Translation2d center, double radius) {
		if (radius < kReallyBigNumber) {
			...
			// If the point is behind pose, we want the opposite of this angle.
			// To determine if the point is behind,
			// check the sign of the cross-product between the normal vector and
			// the vector from pose to point.
