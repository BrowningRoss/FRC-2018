...
public class MotionState {
     ...
     * @return A MotionState that is a valid predecessor (if t<=0) or successor
     * (if t>=0) of this state (with the specified accel).
     */
     ...
     * will be at pos. This is an inverse of the extrapolate() method.
     *
     ...
     * within a nominal tolerance, but acceleration may be different).
     */
    ...
    /**
     * Checks if two MotionStates are coincident (t, pos, and vel are equal
     * within a specified tolerance, but acceleration may be different).
     */
