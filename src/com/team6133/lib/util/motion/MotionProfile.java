...
import static com.team6133.lib.util.Util.epsilonEquals;
import static com.team6133.lib.util.motion.MotionUtil.kEpsilon;
...
public class MotionProfile {
     ...
     * MotionState). Note that since a profile may reverse, this method only
     * returns the *first* instance of this position.
     *
     * @param pos The position to query.
     * @return Empty if the profile never crosses pos or if the profile is
     * invalid, or the resulting MotionState otherwise.
     */
     ...
     * segment of length 0 that starts and ends at initial_state).
     *
     ...
     * This is appended to the previous last state.
     *
     ...
     * the sum of absolute distances of all segments, so a reversing
     * profile will count the distance covered in each direction.
     */
