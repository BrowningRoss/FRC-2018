...
public class ProfileFollower {
     ...
     *             position error).
     * @param kffv The feedforward gain on velocity. Should be 1.0 if the units
     *             of the profile match the units of the output.
     ...
     * output.
     *
     * @param latest_state The latest *actual* state, used only for feedback purposes
     *                     (unless this is the first iteration or reset()/resetSetpoint()
     *                     was just called, in which case this is the new start state for
     *                     the profile).
    ...
    public boolean onTarget() {
        ...
        // For the options that don't achieve the goal velocity exactly, also
        // count any instance where we have passed
        // the finish line.
