...
public class Constants extends ConstantsBase {
	...
	// Section 3.13
	// ...and
	// https://firstfrc.blob.core.windows.net/frc2017/Drawings/2017FieldComponents.pdf
	...
	// Wheels
	public static double kDriveWheelDiameterInches = 3.938; // Team 6133's
															// number
	public static double kTrackWidthInches = 19.375; // Team 6133's number
	...
	// Gearbox Ratio (the mag encoder is on the mid shaft of the gear box, so
	// this ratio corrects speed readings)
	public static double kGearboxRatio = 30.0 / 44.0;
	...
	public static double kDriveHighGearVelocityKp = 1.0;
	public static double kDriveHighGearVelocityKi = 0.0007;
	...
	public static double kDriveHighGearMaxSetpoint = 5.0 * 12.0; // 17 fps
	...
	public static double kDriveLowGearMaxVelocity = 6.0 * 12.0 * 60.0 / (Math.PI * kDriveWheelDiameterInches); // 6
																												// fps
																												// in
																												// RPM
	public static double kDriveLowGearMaxAccel = 18.0 * 12.0 * 60.0 / (Math.PI * kDriveWheelDiameterInches); // 18
																												// fps/s
																												// in
																												// RPM/s
	...
	public static double kDriveTurnKi = 0.015; // 1.5;
	...
	public static int kShooterMinOnTargetSamples = 20; // Should be <=
														// kShooterKvBufferSize
	...
	public static final int kLeftDriveSlaveId1 = 8;
	public static final int kLeftDriveSlaveId2 = 2;
	public static final int kRightDriveMasterId = 6;
	public static final int kRightDriverSlaveId1 = 5;
	public static final int kRightDriverSlaveId2 = 1;
	...
	public static double kPathFollowingMaxAccel = 75.0; // inches per second^2
	public static double kPathFollowingMaxVel = 75.0; // inches per second
	public static double kPathFollowingProfileKp = 1.50; // 5.00;
	public static double kPathFollowingProfileKi = 0.05;
	public static double kPathFollowingProfileKv = 0.002;
	...
	public static boolean kUseFlywheelAutoAimPolynomial = true; // Change to
																// 'true' to use
																// the best-fit
																// polynomial
																// instead.
	...
	public static double[][] kFlywheelDistanceRpmValues = {
			// At champs 4/27
			{ 90.0, 2890.0 }, { 95.0, 2940.0 }, { 100.0, 2990.0 }, { 105.0, 3025.0 }, { 110.0, 3075.0 },
			{ 115.0, 3125.0 }, { 120.0, 3175.0 }, { 125.0, 3225.0 }, { 130.0, 3275.0 }, };
