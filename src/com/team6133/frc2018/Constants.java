...
public class Constants extends ConstantsBase {
    ...
    // Wheels
    public static double kDriveWheelDiameterInches = 3.938;  //Team 6133's number
    ...
    public static final int kLeftDriveSlaveId1 = 2;
    public static final int kLeftDriveSlaveId2 = 6;
    public static final int kRightDriveMasterId = 5;
    public static final int kRightDriverSlaveId1 = 1;
    public static final int kRightDriverSlaveId2 = 4;
