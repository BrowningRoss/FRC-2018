...
public class Robot extends IterativeRobot {
    ...
    private final SubsystemManager mSubsystemManager = new SubsystemManager(
            Arrays.asList(
            		Drive.getInstance(),
            		//~!@Superstructure.getInstance(), Shooter.getInstance(), Feeder.getInstance(), Hopper.getInstance(), Intake.getInstance(),
    ...
    public void teleopPeriodic() {
        try {
            ...
            mDrive.setOpenLoop(mDriveHelper.cheesyDrive(throttle, turn, mControlBoard.getQuickTurn(), true));
            ...
            if (wants_aim_button || mControlBoard.getDriveAimButton()) {
                ...
                if (!mSuperstructure.isShooting()) {
                    mDrive.setOpenLoop(mDriveHelper.cheesyDrive(throttle, turn, mControlBoard.getQuickTurn(),
