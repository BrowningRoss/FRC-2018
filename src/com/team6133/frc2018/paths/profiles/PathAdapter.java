package com.team6133.frc2018.paths.profiles;

import com.team6133.frc2018.Constants;
import com.team6133.frc2018.paths.PathBuilder;
import com.team6133.frc2018.paths.PathBuilder.Waypoint;
...
import com.team6133.lib.util.math.Translation2d;
...
public class PathAdapter {
	...
	static final Rotation2d kRedHopperHeading = Rotation2d.fromDegrees(45); // angle
																			// to
																			// hit
																			// the
																			// red
																			// hopper
																			// at
	static final Rotation2d kBlueHopperHeading = Rotation2d.fromDegrees(315); // angle
																				// to
																				// hit
																				// the
																				// blue
																				// hopper
																				// at
	static final Rotation2d kStartHeading = Rotation2d.fromDegrees(180); // start
																			// angle
																			// (backwards)
	static final double kGearPlacementDist = Constants.kCenterToRearBumperDistance + 10; // distance
																							// away
																							// from
																							// the
																							// airship
																							...
																							// gear
																							// at
	static final double kHopperOffsetX = 3.0; // How far from the closest edge
												// of the hopper to aim
	static final double kHopperSkew = 6.0; // How far into the wall to place the
											// final point (to ensure we keep
											// nudging
											// into the wall)
	...
	static final double kHopperTurnDistance = 40; // how long the third segment
													// in the hopper path should
													// be
	static final double kGearTurnDistance = 24; // how long the first segment in
												// the hopper path should be
	static final double kEndHopperPathX = 84.5; // X position we want the hopper
												// path to end at
	static final double kFieldHeight = 324; // total height of the field in
											// inches (doesn't really have to be
											// accurate,
	...
	public static Path getRedHopperPath() {
		if (sRedHopperPath == null) {
			...
			redHopperEndPosition.setX(kEndHopperPathX); // move X position to
														// desired place
			redHopperEndPosition.setY(redHopperEndPosition.y() - kHopperSkew); // TODO
																				// make
																				// constant
	...
	public static Path getBlueHopperPath() {
		if (sBlueHopperPath == null) {
			...
			blueHopperEndPosition.setX(kEndHopperPathX); // move x position to
															// desired place
