...
public class Option_StartRight_EndScoreScale extends AutoModeBase {
    ...
    AutonPathSettings path2 = new AutonPathSettings(FACE_RIGHT, 20, 164, new SensorTarget(SensorTarget.Sensor.Ultra, 10, false), .5);
    AutonPathSettings path3 = new AutonPathSettings(FACE_RIGHT, -12, 0, SensorTarget.ultraScaleLaunchSetpoint, .05);
