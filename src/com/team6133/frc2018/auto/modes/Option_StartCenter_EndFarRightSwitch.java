...
public class Option_StartCenter_EndFarRightSwitch extends AutoModeBase {
    AutonPathSettings path1 = new AutonPathSettings(FACE_LEFT, 0, 40, new SensorTarget(SensorTarget.Sensor.LeftIRPD, 40, true), .1);
    AutonPathSettings path2 = new AutonPathSettings(FACE_RIGHT, 100, 0, new SensorTarget(SensorTarget.Sensor.Ultra, 32, false), 2);
    AutonPathSettings path3 = new AutonPathSettings(FACE_RIGHT, 0, 160, new SensorTarget(SensorTarget.Sensor.RightIRPD, 150, true), .5);
    AutonPathSettings path4 = new AutonPathSettings(FACE_RIGHT, -12,0, new SensorTarget(SensorTarget.Sensor.Ultra, Constants.SWITCH_SIDE_DISTANCE_INCHES, false) , .5);
