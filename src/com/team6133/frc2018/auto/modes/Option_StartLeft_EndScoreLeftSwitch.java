...
public class Option_StartLeft_EndScoreLeftSwitch extends AutoModeBase {
    AutonPathSettings path1a = new AutonPathSettings(FACE_LEFT, 0,160, new SensorTarget(SensorTarget.Sensor.LeftIRPD, 160, false), 0.25, .4);
    AutonPathSettings path1b = new AutonPathSettings(FACE_LEFT, 0,160, new SensorTarget(SensorTarget.Sensor.LeftIRPD, 160, false), 0.25, .55);
    AutonPathSettings path1c = new AutonPathSettings(FACE_LEFT, 0,160, new SensorTarget(SensorTarget.Sensor.LeftIRPD, 160, false), 0.25, .66);
    AutonPathSettings path1 = new AutonPathSettings(FACE_LEFT, 0,160, new SensorTarget(SensorTarget.Sensor.LeftIRPD, 160, true), 0.5, .75);
