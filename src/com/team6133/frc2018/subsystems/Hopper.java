 ...
 * are all powered by two 775 Pro motors hooked up two 2 talons. The motors are
 * open loop controlled. The main things this subsystem has to are feed fuel,
 * exhaust fuel, and unjam fuel.
 * 
 * @see Subsystem.java
 */
public class Hopper extends Subsystem {
	...
	private Hopper() {
		 ...
		 * 500); mMasterTalon.reverseOutput(false);
		 * 
		 * mSlaveTalon =
		 * CANTalonFactory.createDefaultTalon(Constants.kHopperSlaveId);
		 ...
		 * 500); mSlaveTalon.EnableCurrentLimit(true);
