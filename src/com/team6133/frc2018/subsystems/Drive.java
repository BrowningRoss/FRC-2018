...
public class Drive extends Subsystem {
	...
	public enum DriveControlState {
		...
		DRIVE_TOWARDS_GOAL_APPROACH // drive forwards until we are at optimal
									// shooting distance
	}
	...
	// Hardware
	private final CANTalon mLeftMaster, mRightMaster, mLeftSlave1, mRightSlave1, mLeftSlave2, mRightSlave2;
	...
	private Drive() {
		...
		mLeftSlave1 = CANTalonFactory.createPermanentSlaveTalon(Constants.kLeftDriveSlaveId1,
				Constants.kLeftDriveMasterId);
		mLeftSlave1.reverseOutput(false);
		mLeftSlave2 = CANTalonFactory.createPermanentSlaveTalon(Constants.kLeftDriveSlaveId2,
				Constants.kLeftDriveMasterId);
		mLeftSlave2.reverseOutput(false);
		...
		mRightSlave1 = CANTalonFactory.createPermanentSlaveTalon(Constants.kRightDriverSlaveId1,
				Constants.kRightDriveMasterId);
		mRightSlave1.reverseOutput(false);
		mRightSlave2 = CANTalonFactory.createPermanentSlaveTalon(Constants.kRightDriverSlaveId2,
				Constants.kRightDriveMasterId);
		mRightSlave2.reverseOutput(false);
		...
		// ~!@mShifter =
		// Constants.makeSolenoidForId(Constants.kShifterSolenoidId);
	...
	public synchronized void setBrakeMode(boolean on) {
		if (mIsBrakeMode != on) {
			...
			mRightSlave2.enableBrakeMode(on);
			mLeftMaster.enableBrakeMode(on);
			mLeftSlave1.enableBrakeMode(on);
			mLeftSlave2.enableBrakeMode(on);
		}
	}
	...
	public void outputToSmartDashboard() {
		...
		SmartDashboard.putNumber("left position (rotations)", mLeftMaster.getPosition() * Constants.kGearboxRatio);
		SmartDashboard.putNumber("right position (rotations)", mRightMaster.getPosition() * Constants.kGearboxRatio);
	...
	public synchronized void resetEncoders() {
		...
		mLeftSlave1.setPosition(0);
		mRightSlave1.setPosition(0);
		mLeftSlave2.setPosition(0);
		mRightSlave2.setPosition(0);
	}
	...
	public double getLeftDistanceInches() {
		return rotationsToInches(mLeftMaster.getPosition() * Constants.kGearboxRatio);
	}

	public double getRightDistanceInches() {
		return rotationsToInches(mRightMaster.getPosition() * Constants.kGearboxRatio);
	}

	public double getLeftVelocityInchesPerSec() {
		return rpmToInchesPerSecond(mLeftMaster.getSpeed() * Constants.kGearboxRatio);
	}

	public double getRightVelocityInchesPerSec() {
		return rpmToInchesPerSecond(mRightMaster.getSpeed() * Constants.kGearboxRatio);
	}
	...
	private void updateTurnToHeading(double timestamp) {
		if (Superstructure.getInstance().isShooting()) {
			// Do not update heading while shooting - just base lock. By not
			// updating the setpoint, we will fight to
			// keep position.
			return;
		}
	 ...
	 * robot into the DRIVE_TOWARDS_GOAL_APPROACH state if it detects we are not
	 * at an optimal shooting range
	 */
	...
	public boolean checkSystem() {
		...
		mRightSlave2.changeControlMode(CANTalon.TalonControlMode.Voltage);
		...
		final double rpmRightMaster = mRightMaster.getSpeed() * Constants.kGearboxRatio;
		...
		Timer.delay(4.0);
		final double currentRightSlave1 = mRightSlave1.getOutputCurrent();
		final double rpmRightSlave1 = mRightMaster.getSpeed() * Constants.kGearboxRatio;
		mRightSlave1.set(0.0f);

		Timer.delay(2.0);

		mRightSlave2.set(-6.0f);
		Timer.delay(4.0);
		final double currentRightSlave2 = mRightSlave2.getOutputCurrent();
		final double rpmRightSlave2 = mRightMaster.getSpeed() * Constants.kGearboxRatio;
		mRightSlave2.set(0.0f);
		...
		final double rpmLeftMaster = mLeftMaster.getSpeed() * Constants.kGearboxRatio;
		...
		final double rpmLeftSlave1 = mLeftMaster.getSpeed() * Constants.kGearboxRatio;
		mLeftSlave1.set(0.0);
		...
		final double rpmLeftSlave2 = mLeftMaster.getSpeed() * Constants.kGearboxRatio;
		mLeftSlave2.set(0.0);
		...
		mRightSlave2.changeControlMode(CANTalon.TalonControlMode.Follower);
		mRightSlave2.set(Constants.kRightDriveMasterId);
		...
		mLeftSlave2.set(Constants.kLeftDriveMasterId);

		System.out.println("Drive Right Master Current: " + currentRightMaster + " Drive Right Slave 1 Current: "
				+ currentRightSlave1 + "Drive Right Slave 2 Current: " + currentRightSlave2);
		System.out.println("Drive Left Master Current: " + currentLeftMaster + " Drive Left Slave 1 Current: "
				+ currentLeftSlave1 + " Drive Left Slave 2 Current: " + currentLeftSlave2);
		System.out.println(
				"Drive RPM RMaster: " + rpmRightMaster + " RSlave1: " + rpmRightSlave1 + " RSlave2: " + rpmRightSlave2
						+ " LMaster: " + rpmLeftMaster + " LSlave1: " + rpmLeftSlave1 + " LSlave2: " + rpmLeftSlave2);
		...
		if (currentRightSlave1 < kCurrentThres) {
			failure = true;
			System.out.println("!!!!!!!!!!!!!!!!!! Drive Right Slave 1 Current Low !!!!!!!!!!");
		}

		if (currentRightSlave2 < kCurrentThres) {
			failure = true;
			System.out.println("!!!!!!!!!!!!!!!!!! Drive Right Slave 2 Current Low !!!!!!!!!!");
		}
		...
		if (currentLeftSlave1 < kCurrentThres) {
			failure = true;
			System.out.println("!!!!!!!!!!!!!!!!!! Drive Left Slave 1 Current Low !!!!!!!!!!");
		}

		if (currentLeftSlave2 < kCurrentThres) {
			failure = true;
			System.out.println("!!!!!!!!!!!!!!!!!! Drive Left Slave 2 Current Low !!!!!!!!!!");
		}

		if (!Util.allCloseTo(Arrays.asList(currentRightMaster, currentRightSlave1, currentRightSlave2),
				currentRightMaster, 5.0)) {
			failure = true;
			System.out.println("!!!!!!!!!!!!!!!!!! Drive Right Currents Different !!!!!!!!!!");
		}

		if (!Util.allCloseTo(Arrays.asList(currentLeftMaster, currentLeftSlave1, currentLeftSlave2), currentLeftMaster,
				5.0)) {
			failure = true;
		...
		if (rpmRightSlave1 < kRpmThres) {
			failure = true;
			System.out.println("!!!!!!!!!!!!!!!!!! Drive Right Slave 1 RPM Low !!!!!!!!!!!!!!!!!!!");
		}

		if (rpmRightSlave2 < kRpmThres) {
			failure = true;
			System.out.println("!!!!!!!!!!!!!!!!!! Drive Right Slave 2 RPM Low !!!!!!!!!!!!!!!!!!!");
		}
		...
		if (rpmLeftSlave1 < kRpmThres) {
			failure = true;
			System.out.println("!!!!!!!!!!!!!!!!!! Drive Left Slave 1 RPM Low !!!!!!!!!!!!!!!!!!!");
		}

		if (rpmLeftSlave2 < kRpmThres) {
			failure = true;
			System.out.println("!!!!!!!!!!!!!!!!!! Drive Left Slave 2 RPM Low !!!!!!!!!!!!!!!!!!!");
		}

		if (!Util.allCloseTo(Arrays.asList(rpmRightMaster, rpmRightSlave1, rpmRightSlave2, rpmLeftMaster, rpmLeftSlave1,
				rpmLeftSlave2), rpmRightMaster, 250)) {
			failure = true;
