...
public class Drive extends Subsystem {
    ...
    public boolean checkSystem() {
        ...
        final double rpmRightSlave1 = mRightMaster.getSpeed();
        ...
        final double rpmRightSlave2 = mRightMaster.getSpeed();
        ...
        final double rpmLeftSlave1 = mLeftMaster.getSpeed();
        mLeftSlave1.set(0.0);
        ...
        final double rpmLeftSlave2 = mLeftMaster.getSpeed();
        mLeftSlave2.set(0.0);
        ...
        System.out.println(
                "Drive Left Master Current: " + currentLeftMaster + " Drive Left Slave 1 Current: " + currentLeftSlave1 + 
                " Drive Left Slave 2 Current: " + currentLeftSlave2);
        System.out.println("Drive RPM RMaster: " + rpmRightMaster + " RSlave1: " + rpmRightSlave1 + " RSlave2: " + rpmRightSlave2 + 
        ...
        if (!Util.allCloseTo(Arrays.asList(currentRightMaster, currentRightSlave1, currentRightSlave2), currentRightMaster,
                5.0)) {
            failure = true;
        ...
        if (!Util.allCloseTo(Arrays.asList(rpmRightMaster, rpmRightSlave1, rpmRightSlave2, rpmLeftMaster, rpmLeftSlave1, rpmLeftSlave2),
                rpmRightMaster, 250)) {
            failure = true;
