...
/**
 * The feeder subsystem consists of the 5 rollers that feed fuel upwards into
 * the shooter. The rollers are powered by 2 775 Pro motors hooked up to two
 * talons. The motors are open loop controlled. The main things this subsystem
 * has to are feed fuel, exhaust fuel, and unjam
 * 
 * @see Subsystem.java
 */
public class Feeder extends Subsystem {
	...
	public Feeder() {
		/*
		 * ~!@ mMasterTalon =
		 * CANTalonFactory.createDefaultTalon(Constants.kFeederMasterId);
		 * 
		 * mMasterTalon.setFeedbackDevice(CANTalon.FeedbackDevice.
		 ...
		 * mMasterTalon.SetVelocityMeasurementPeriod(CANTalon.
		 ...
		 * mMasterTalon.setVoltageCompensationRampRate(Constants.
		 * kFeederVoltageCompensationRampRate);
		 * mMasterTalon.setNominalClosedLoopVoltage(12.0);
		 * 
		 * mMasterTalon.setStatusFrameRateMs(CANTalon.StatusFrameRate.Feedback,
		 * 1000);
		 * 
		 * mSlaveTalon =
		 * CANTalonFactory.createPermanentSlaveTalon(Constants.kFeederSlaveId,
		 * Constants.kFeederMasterId); mSlaveTalon.reverseOutput(true);
	...
	private SystemState handleFeeding() {
		if (mStateChanged) {
			...
			// Constants.kFeederSensorGearReduction);
	...
	public void outputToSmartDashboard() {
		// SmartDashboard.putNumber("feeder_speed", mMasterTalon.get() /
		// Constants.kFeederSensorGearReduction);
	}
	...
	public boolean checkSystem() {
		 ...
		 * 
		 * mSlaveTalon.set(0.0); mMasterTalon.set(0.0);
		 * 
		 * mMasterTalon.set(6.0f); Timer.delay(4.0); final double currentMaster
		 * = mMasterTalon.getOutputCurrent(); final double rpmMaster =
		 * mMasterTalon.getSpeed(); mMasterTalon.set(0.0f);
		 * 
		 * Timer.delay(2.0);
		 * 
		 * mSlaveTalon.set(-6.0f); Timer.delay(4.0); final double currentSlave =
		 * mSlaveTalon.getOutputCurrent(); final double rpmSlave =
		 * mMasterTalon.getSpeed(); mSlaveTalon.set(0.0f);
		 * 
		 * mSlaveTalon.changeControlMode(TalonControlMode.Follower);
		 * mSlaveTalon.set(Constants.kFeederMasterId);
		 * 
		 * System.out.println("Feeder Master Current: " + currentMaster +
		 * " Slave Current: " + currentSlave + " rpmMaster: " + rpmMaster +
		 * " rpmSlave: " + rpmSlave);
		 */
		boolean failure = false;
		/*
		 * ~!@ if (currentMaster < kCurrentThres) { failure = true; System.out.
		 * println("!!!!!!!!!!!!!! Feeder Master Current Low !!!!!!!!!!!!!!!!");
		 * }
		 * 
		 * if (currentSlave < kCurrentThres) { failure = true; System.out.
		 * println("!!!!!!!!!!!!!! Feeder Slave Current Low !!!!!!!!!!!!!!!!!");
		 * }
		 * 
		 * if (!Util.allCloseTo(Arrays.asList(currentMaster, currentSlave),
		 * currentMaster, 5.0)) { failure = true; System.out.
		 * println("!!!!!!!!!!!!!!! Feeder currents different!!!!!!!!!!!!!!!");
		 * }
		 * 
		 * if (rpmMaster < kRpmThes) { failure = true; System.out.
		 * println("!!!!!!!!!!!!!! Feeder Master RPM Low !!!!!!!!!!!!!!!!!!!!!!!!!"
		 * ); }
		 * 
		 * if (rpmSlave < kRpmThes) { failure = true; System.out.
		 * println("!!!!!!!!!!!!!! Feeder Slave RPM Low !!!!!!!!!!!!!!!!!!!!!!!!!"
		 * ); }
		 * 
		 * if (!Util.allCloseTo(Arrays.asList(rpmMaster, rpmSlave), rpmMaster,
		 * 250)) { failure = true; System.out.
		 * println("!!!!!!!!!!!!!! Feeder RPM different !!!!!!!!!!!!!!!!!!!!!!!!!"
		 * ); }
		 */
		return !failure;
	}
