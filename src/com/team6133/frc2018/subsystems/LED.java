 ...
 * used for aiming and communicating information with the drivers (when a gear
 * is picked up, when the robot loses connection) and the blue "range finding"
...
public class LED extends Subsystem {
	...
	public static final double kDefaultBlinkDuration = 0.2; // seconds for full
															// cycle
